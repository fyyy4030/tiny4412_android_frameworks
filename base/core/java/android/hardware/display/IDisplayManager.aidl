...
interface IDisplayManager {
    ...
    void setHDMIXOverScan(int xOverScan);
    int getHDMIXOverScan();
    void setHDMIYOverScan(int yOverScan);
    int getHDMIYOverScan();
    void setHDMIKeepRate(int keepRate);
    void setHDMIResolution(int resolution);
    void setHDMIRotAngle(int rotAngle);
    void setHDMINavBarVisible(int navBarVisible);
    int getHDMIKeepRate();
    int getHDMIResolution();
    int getHDMIRotAngle();
    int getHDMINavBarVisible();
    String getHDMIMode();
    String getHDMIName();
