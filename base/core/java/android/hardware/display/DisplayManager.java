...
public final class DisplayManager {
    ...
    public boolean isHDMIConnected() {
        return mGlobal.isHDMIConnected();
    }

    /* @hide */
    public void setHDMIXOverScan(int xOverScan) {
        mGlobal.setHDMIXOverScan(xOverScan);
    }

    /* @hide */
    public int getHDMIXOverScan() {
        return mGlobal.getHDMIXOverScan();
    }

    /* @hide */
    public void setHDMIYOverScan(int yOverScan) {
        mGlobal.setHDMIYOverScan(yOverScan);
    }

    /* @hide */
    public int getHDMIYOverScan() {
        return mGlobal.getHDMIYOverScan();
    }

    /* @hide */
    public void setHDMIKeepRate(int keepRate) {
        mGlobal.setHDMIKeepRate(keepRate);
    }

    /* @hide */
    public void setHDMIResolution(int keepRate) {
        mGlobal.setHDMIResolution(keepRate);
    }

    /* @hide */
    public void setHDMIRotAngle(int rotAngle) {
        mGlobal.setHDMIRotAngle(rotAngle);
    }

    /* @hide */
    public void setHDMINavBarVisible(int navBarVisible) {
        mGlobal.setHDMINavBarVisible(navBarVisible);
    }

    /* @hide */
    public int getHDMIKeepRate() {
        return mGlobal.getHDMIKeepRate();
    }

    /* @hide */
    public int getHDMIResolution() {
        return mGlobal.getHDMIResolution();
    }

    /* @hide */
    public int getHDMIRotAngle() {
        return mGlobal.getHDMIRotAngle();
    }

    /* @hide */
    public int getHDMINavBarVisible() {
        return mGlobal.getHDMINavBarVisible();
    }

    /* @hide */
    public String getHDMIMode() {
        return mGlobal.getHDMIMode();
    }

    /* @hide */
    public String getHDMIName() {
        return mGlobal.getHDMIName();
    }
