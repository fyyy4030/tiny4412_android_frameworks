...
public final class DisplayManagerService extends SystemService {
    ...
    private static final int MSG_UPDATE_HDMI_OVERSCAN = 6;
    ...
    public void systemReady(boolean safeMode, boolean onlyCore) {
        ...
        mHandler.sendEmptyMessage(MSG_UPDATE_HDMI_OVERSCAN);
    }
    ...
    private void registerDefaultDisplayAdapter() {
        ...
        synchronized (mSyncRoot) {
            mLocalDisplayAdapter = new LocalDisplayAdapter(
    ...
    private final class DisplayManagerHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_UPDATE_HDMI_OVERSCAN:
                    update_hdmi_overscan();
                    break;
            }
        }
    }
    ...
    private final class BinderService extends IDisplayManager.Stub {
        ...
        //{{ TZS/ start HDMI OverScan code

        // Binder call
        public boolean isHDMIConnected() {
            synchronized (mSyncRoot) {
                if (mLocalDisplayAdapter != null) {
                    return mLocalDisplayAdapter.getHDMIConnectState();
                }
            }
            return false;
        }
        ...
        public void setHDMIXOverScan(int xOverScan) {
            ...
            try {
                synchronized (mSyncRoot) {
                    if (mLocalDisplayAdapter != null) {
                        mLocalDisplayAdapter.setHDMIXOverScan(xOverScan);
                    }
                }
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        public int getHDMIXOverScan() {
            synchronized (mSyncRoot) {
                if (mLocalDisplayAdapter != null) {
                    return mLocalDisplayAdapter.getHDMIXOverScan();
                }
            }
            return 0;
        }
        ...
        public void setHDMIYOverScan(int yOverScan) {
            ...
            try {
                synchronized (mSyncRoot) {
                    if (mLocalDisplayAdapter != null) {
                        mLocalDisplayAdapter.setHDMIYOverScan(yOverScan);
                    }
                }
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        public int getHDMIYOverScan() {
            synchronized (mSyncRoot) {
                if (mLocalDisplayAdapter != null) {
                    return mLocalDisplayAdapter.getHDMIYOverScan();
                }
            }
            return 0;
        }
        ...
        public void setHDMIKeepRate(int keepRate) {
            ...
            try {
                synchronized (mSyncRoot) {
                    if (mLocalDisplayAdapter != null) {
                        mLocalDisplayAdapter.setHDMIKeepRate(keepRate);
                    }
                }
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        public void setHDMIResolution(int resolution) {
            ...
            try {
                synchronized (mSyncRoot) {
                    if (mLocalDisplayAdapter != null) {
                        mLocalDisplayAdapter.setHDMIResolution(resolution);
                    }
                }
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        // Binder call
        public void setHDMIRotAngle(int angle) {
            final long token = Binder.clearCallingIdentity();
            try {
                synchronized (mSyncRoot) {
                    if (mLocalDisplayAdapter != null) {
                        mLocalDisplayAdapter.setHDMIRotAngle(angle);
                    }
                }
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        // Binder call
        public void setHDMINavBarVisible(int visible) {
            final long token = Binder.clearCallingIdentity();
            try {
                synchronized (mSyncRoot) {
                    if (mLocalDisplayAdapter != null) {
                        mLocalDisplayAdapter.setHDMINavBarVisible(visible);
                    }
                }
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        public int getHDMIKeepRate() {
            synchronized (mSyncRoot) {
                if (mLocalDisplayAdapter != null) {
                    return mLocalDisplayAdapter.getHDMIKeepRate();
                }
            }
            return 0;
        }
        ...
        public int getHDMIResolution() {
            synchronized (mSyncRoot) {
                if (mLocalDisplayAdapter != null) {
                    return mLocalDisplayAdapter.getHDMIResolution();
                }
            }
            return 0;
        }
        ...
        public int getHDMIRotAngle() {
            synchronized (mSyncRoot) {
                if (mLocalDisplayAdapter != null) {
                    return mLocalDisplayAdapter.getHDMIRotAngle();
                }
            }
            return 0;
        }
        ...
        public int getHDMINavBarVisible() {
            synchronized (mSyncRoot) {
                if (mLocalDisplayAdapter != null) {
                    return mLocalDisplayAdapter.getHDMINavBarVisible();
                }
            }
            return 0;
        }
        ...
        public String getHDMIName() {
            ...
            try {
                synchronized (mSyncRoot) {
                    if (mLocalDisplayAdapter != null) {
                        return mLocalDisplayAdapter.getHDMIName();
                    }
                }
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        public String getHDMIMode() {
            ...
            try {
                synchronized (mSyncRoot) {
                    if (mLocalDisplayAdapter != null) {
                        return mLocalDisplayAdapter.getHDMIMode();
                    }
                }
            } finally {
                Binder.restoreCallingIdentity(token);
    ...
    private void update_hdmi_overscan() {
        final int count = mDisplayDevices.size();
        for (int i = 0; i < count; i++) {
            DisplayDevice device = mDisplayDevices.get(i);
            if (device.getNameLocked().toLowerCase().contains("hdmi") &&
                    mLocalDisplayAdapter != null) {
                mLocalDisplayAdapter.updateLocalDisplay();
                break;
            }
        }
    }
